...
namespace Derpi_Downloader.Forms
{
    public sealed partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            _saveSettingsButton.Enabled = DerpiAPI.CheckAPI(Globals.APIKey);
            Globals.APIKeyChanged += () => _saveSettingsButton.Enabled = DerpiAPI.CheckAPI(Globals.APIKey);
            ...
            _downloadPathTextBox.Text = Globals.CurrentDownloadFolder;
            ...
            _downloadNameTextBox.Text = Globals.CurrentDownloadFileName;
            ...
            Globals.CurrentDownloadFolderChanged += OnCurrentPathChanged;
            Globals.CurrentDownloadFileNameChanged += OnCurrentPathChanged;
            ...
            _existFileRewriteCheckBox.Checked = Globals.ExistFileRewrite;
            ...
            _convertSVGToPNGCheckBox.Checked = Globals.ConvertSVGToPNG;
            _convertSVGToPNGCheckBox.CheckedChanged += OnConvertSVGToPngCheckBoxCheckBoxClick;
            _convertSVGToPNGCheckBox.Enabled = false;

            Globals.ExistFileRewriteChanged += () => _existFileRewriteCheckBox.Checked = Globals.ExistFileRewrite;
